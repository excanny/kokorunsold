...
class Association extends BaseController
{
    ...
    public function dashboard($id = null)
     {
	   ...
	   //var_dump($data['association_details']);
	...
	public function updateaboutaction()
	{
		...
		$data = [
			...
			'fassociation_director' => $this->request->getPost('association_director'),
	...
	public function messagedetails($job_id, $applicant_id)
	{
		...
		$job_invite_message = new JobInviteMessageModel();
		$data['messages'] = $job_invite_message->where('fjob_id', $job_id)->where('fuser_id', $association_id)->orderBy('frecno', 'asc')->findAll();
